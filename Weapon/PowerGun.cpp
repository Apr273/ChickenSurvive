...
//	//m_crit_rate = 0.3f;
//	//m_bullet_picture = std::string("bullet_2.png");
//	auto sprite = Sprite::create("bullet_2.png");
//	bindSprite(sprite);
//	/*bindSprite(Sprite::create("PowerGun!.png"));
//	m_sprite->setAnchorPoint(Vec2(0.0f, 0.5f));*/
//	m_weaponName = "PowerGun!";
//	//test
